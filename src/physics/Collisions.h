...
bool Box_Circle_collision(const Rigid box, const Rigid circle, vec2 *normal, float *depth)
{
    ...
    for (size_t i = 0; i < box.vert_count; i++)
    {
        ...
        _project_verticies(box.transformed_verticies, box.vert_count, axis, &min1, &max1);
